"""
Django settings for sbsta_43347 project.
...
WSGI_APPLICATION = 'sbsta_43347.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sbsta_43347 API",
    "DESCRIPTION": "API documentation for sbsta_43347 App",
    "VERSION": "v1",
}
